...
# -------------------------------
# 🧩 Parametergrid für Adagrad-Test
# -------------------------------
param_grid = {
    ...
    "adagradconst": [1e-8, 1e-6, 1e-4]
}

keys = list(param_grid.keys())
combinations = list(itertools.product(*param_grid.values()))
print(f"Starte Adagrad-Test mit {len(combinations)} Kombinationen...\n")
...
for i, combo in enumerate(combinations):
    ...
    print(f"[{i+1}/{len(combinations)}] AdagradConst={params['adagradconst']}, Reg={params['regul']}, Dropout={params['dropout']}, Arch={params['hiddenlayer']}")
    ...
    try:
        exe = MLP(
            ...
            adagradconst=params["adagradconst"],
...
df.to_csv("Adagrad_Test.csv", sep=";", index=False)
print("\n✅ Ergebnisse gespeichert in 'Adagrad_Test.csv'")

# -------------------------------
# 🏆 Beste Modelle anzeigen
# -------------------------------
best = df.sort_values("R2", ascending=False).head(10)
print("\n🏆 Beste Modelle (nach R² sortiert):")
print(best)
